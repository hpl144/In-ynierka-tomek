    ...
    <div className="App" style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
      ...
      <div style={{ width: "800px", padding: "20px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between" }} className="row">
          ...
          <p>Tw_1'': {Math.round(row2[0][0] * 100000) / 100000}</p>
          <p>Ta_1'': {Math.round(row2[0][1] * 100000) / 100000}</p>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between" }} className="row">
          <p>Tw_2: {Math.round(row1[1][0] * 100000) / 100000}</p>
          <p>Ta_2: {Math.round(row1[1][1] * 100000) / 100000}</p>
          <p>Tw_2'': {Math.round(row2[1][0] * 100000) / 100000}</p>
          <p>Ta_2'': {Math.round(row2[1][1] * 100000) / 100000}</p>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between" }} className="row">
          <p>Tw_3: {Math.round(row1[2][0] * 100000) / 100000}</p>
          <p>Ta_3: {Math.round(row1[2][1] * 100000) / 100000}</p>
          <p>Tw_3'': {Math.round(row2[2][0] * 100000) / 100000}</p>
          <p>Ta_3'': {Math.round(row2[2][1] * 100000) / 100000}</p>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between" }} className="row">
          <p>Tw_4: {Math.round(row1[3][0] * 100000) / 100000}</p>
          <p>Ta_4: {Math.round(row1[3][0] * 100000) / 100000}</p>
          <p>Tw_4'': {Math.round(row2[3][0] * 100000) / 100000}</p>
          <p>Ta_4'': {Math.round(row2[3][1] * 100000) / 100000}</p>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between" }} className="row">
          <p>Tw_5: {Math.round(row1[4][0] * 100000) / 100000}</p>
          <p>Ta_5: {Math.round(row1[4][1] * 100000) / 100000}</p>
          <p>Tw_5'': {Math.round(row2[4][0] * 100000) / 100000}</p>
          <p>Ta_5'': {Math.round(row2[4][1] * 100000) / 100000}</p>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between" }} className="row">
          ...
          <p>AVG_Tw'': {Math.round(((row2[0][0] + row2[1][0] + row2[2][0] + row2[3][0] + row2[4][0]) / 5) * 100000) / 100000}</p>
          <p>AVG_Ta'': {Math.round(((row2[0][1] + row2[1][1] + row2[2][1] + row2[3][1] + row2[4][1]) / 5) * 100000) / 100000}</p>
        </div>
      </div>
    </div>
  );
